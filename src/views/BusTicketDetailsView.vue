        ...
        <div v-else-if="ticket">
            ...
            <div class="px-5 py-6 space-y-4">
                ...
                <div v-if="ticket.operator_phone">
                    <a :href="`tel:${ticket.operator_phone.replace(/[^\d+]/g, '')}`" 
                        @click.prevent="makeCall"
                        class="w-full py-4 rounded-2xl font-bold text-lg shadow-lg bg-green-500 text-white flex items-center justify-center gap-2 mb-3 active:scale-95 transition-all shadow-green-500/20">
