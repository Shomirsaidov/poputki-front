                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="text-right space-y-4">
                                    ...
                                    <div v-if="b.operator_phone">
                                        <a :href="`tel:${b.operator_phone.replace(/[^\d+]/g, '')}`" @click.stop class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-600 rounded-xl font-bold text-xs ring-1 ring-green-100 active:scale-95 transition-all">
