                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="text-right space-y-4">
                                    ...
                                    <div v-if="b.operator_phone">
                                        <button @click.stop="makeCall(b.operator_phone)" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-600 rounded-xl font-bold text-xs ring-1 ring-green-100 active:scale-95 transition-all">
