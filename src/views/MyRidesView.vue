                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between bg-white p-3 rounded-2xl">
                                ...
                                <button @click.stop="makeCall(ride.driver_phone)" class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-600 hover:bg-green-200 transition-colors" v-if="!isDriver(ride)">
