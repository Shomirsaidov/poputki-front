                  ...
                  <div class="mt-8 mb-6">
                      <template v-if="isPastRide">
                          ...
                          <button 
                             v-else
                             disabled
                             class="w-full py-4 rounded-2xl font-bold text-lg shadow-xl bg-slate-100 text-slate-500 shadow-slate-100/30 opacity-70 flex items-center justify-center space-x-2"
                          >
